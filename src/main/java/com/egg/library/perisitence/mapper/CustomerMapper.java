...
@Mapper(componentModel = "spring",uses={UserMapper.class,LoanMapper.class,PictureMapper.class,BookMapper.class})
public interface CustomerMapper {
    @Mappings({
            ...
            @Mapping(source = "librosFavoritos",target = "favoriteBooks")
    })
